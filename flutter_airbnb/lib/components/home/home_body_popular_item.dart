...
import 'package:flutter_airbnb/constraints.dart';
...
class HomeBodyPopularItem extends StatelessWidget {
  ...
  Widget _buildPopularItemComment() {
    return Column(
      children: [
        Text(
          "깔끕하고 다 갖춰져있어서 좋았어요:) 위치도 완전 좋아용 다들 여기 살고싶다구ㅋㅋㅋㅋㅋ 화장실도 3개예요!!! 5명이서 씻는것도 전혀 불편함없이 좋았어요^^ 이불도 포근하고 좋습니다ㅎㅎ",
          style: body1(),
          maxLines: 3, // 2. 글자 라인을 제한할 수 있다.
          overflow: TextOverflow.ellipsis, // 3. 글자가 3라인을 넘어가면 ... 처리된다.
        ),
